...
namespace TheStore.Endpoints.Tests.UnitTests.Products
{
	public class SingleProductsSpec
	{
		...
		public async Task Can_Update_Single_Product()
		{
			...
			//	fixture.Create<string>(), fixture.Create<string>(),
			//	fixture.Create<MoneyDto>(), fixture.Create<InventoryRecordDto>(),
			//	fixture.CreateMany<ProductColorDto>(5).ToList());

            ...
            modelBuilder.Entity("TheStore.Catalog.Core.Aggregates.Products.ProductSpecification", b =>
                {
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("Name", "TheStore.Catalog.Core.Aggregates.Products.ProductSpecification.Name#MultilanguageString", b1 =>
                        {
                            b1.IsRequired();
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("Value", "TheStore.Catalog.Core.Aggregates.Products.ProductSpecification.Value#MultilanguageString", b1 =>
                        {
                            b1.IsRequired();
